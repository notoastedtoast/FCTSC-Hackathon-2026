...
const MIN_LENGTH=10,MAX_LENGTH=10000,ANALYSIS_LIMIT=10,MESSAGE_REVEAL_INTERVAL_MS=2000,DRAFT_KEY='scamcheck-message-draft',OFFLINE_HISTORY_KEY='scamcheck-offline-history-v1',PENDING_ANALYSIS_KEY='scamcheck-pending-analysis-v1',DISPLAY_PREFERENCES_KEY='scamcheck-display-preferences-v1',MAX_OFFLINE_HISTORY=10,SHARE_PRODUCT_URL='https://fctsc-hackathon-2026.vercel.app/';
const PAGE_ANALYSIS_SESSION_ID=globalThis.crypto?.randomUUID?.()||`page-${Date.now()}-${Math.random().toString(16).slice(2)}`;
...
let detectiveSequenceComplete=false,psychologyReady=false;
