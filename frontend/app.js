...
let lastCheckAt=Number(sessionStorage.getItem('scamcheck-last-check-at')||0),cooldownTimer=null,recognition=null,isRecording=false,selectedHistoryIds=new Set(),activeCheckController=null;
...
setupSpeechRecognition();updateInputState();renderPracticePrompt();void loadUsage();if(isCooldownActive())updateCooldownState();
