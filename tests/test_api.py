...
class ApiTests(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_root_serves_integrated_frontend_and_logo(self) -> None:
        ...
        async with httpx.AsyncClient(
            ...
            responder_avatar = await client.get("/responder-avatar.png")
        ...
        self.assertEqual(responder_avatar.status_code, 200)
        self.assertEqual(responder_avatar.headers["content-type"], "image/png")
        self.assertTrue(responder_avatar.content.startswith(b"\x89PNG\r\n\x1a\n"))
