...
class FrontendTests(unittest.TestCase):
    ...
    def test_static_page_calls_backend_and_keeps_results_separate(self) -> None:
        ...
        self.assertIn("const PAGE_ANALYSIS_SESSION_ID=", script)
        self.assertIn("'X-ScamCheck-Page-Session':PAGE_ANALYSIS_SESSION_ID", script)
        self.assertIn("function resetRemainingAnalysesOnReload()", script)
        self.assertIn("resetRemainingAnalysesOnReload();restoreDraft()", script)
        ...
        self.assertNotIn("ANALYSIS_REMAINING_KEY", script)
        self.assertIn(
        ...
        self.assertIn("function createProductQrMatrix()", script)
        ...
        self.assertIn("drawProductQr(context,850,footerTop+21,146)", script)
        ...
        self.assertIn("MESSAGE_REVEAL_INTERVAL_MS=2000", script)
        ...
        self.assertIn("window.setTimeout(revealNext,MESSAGE_REVEAL_INTERVAL_MS)", script)
        self.assertIn("message.hidden=false", script)
        self.assertIn("onAnalysisResult:initialPayload=>", script)
        self.assertIn("showResultFrame(submittedText,initialPayload)", script)
        self.assertIn("completeResultFrame(submittedText,payload)", script)
        ...
        self.assertIn("function clearMessageRevealTimers()", script)
        self.assertIn("detectiveSequenceComplete=true", script)
        self.assertIn("if(!detectiveSequenceComplete||!psychologyReady", script)
        ...
        self.assertIn("postAnalysisQuestion.dataset.eligible=String(shouldShow)", script)
        ...
        self.assertIn("function renderResponderGuidance(choice,riskLevel)", script)
        ...
        self.assertIn("revealRowsSequentially(items)", script)
